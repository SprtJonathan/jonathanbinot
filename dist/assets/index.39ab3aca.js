...
page. Bonne visite.`},en:{homepageIntroName:"Jonathan Binot",homepageIntroJob:"Web developer - Frontend - JS Apps",homepageIntroSummary:"Welcome to my personnal website<br /> Different pages are available here, you will find my resume in English and in French, as well as my portfolio in the two languages too.<br /> But before anything else, who am I?",homepageIntroIntroduction:`My name is Jonathan Binot, I'm <span id="age">${ve}</span> year old and I
  ...
  <div id="background-2" class="hidden homepage--background homepage--background--darkgrey" style="background-image: url(${wt})"></div>
  ...
  `;function we(){const t=document.createElement("main");t.setAttribute("class","homepage"),t.setAttribute("id","homepage"),t.appendChild(B),t.innerHTML+=Ct;function o(){const c=window.innerHeight;c>=window.pageYOffset?(document.getElementById("background-1").className="homepage--background homepage--background--image",document.getElementById("background-2").className="hidden homepage--background homepage--background--image",document.getElementById("background-3").className="hidden homepage--background homepage--background--image",document.getElementById("background-4").className="hidden homepage--background homepage--background--image",document.getElementById("background-5").className="hidden",document.getElementById("background-6").className="hidden homepage--background"):c*3>=window.pageYOffset&&window.pageYOffset>=c?(document.getElementById("background-1").className="hidden homepage--background homepage--background--image",document.getElementById("background-2").className="homepage--background homepage--background--image",document.getElementById("background-3").className="hidden homepage--background homepage--background--image",document.getElementById("background-4").className="hidden homepage--background homepage--background--image",document.getElementById("background-5").className="hidden",document.getElementById("background-6").className="hidden homepage--background"):c*5>=window.pageYOffset&&window.pageYOffset>=c*3&&(document.getElementById("background-1").className="hidden homepage--background homepage--background--image",document.getElementById("background-2").className="hidden homepage--background homepage--background--image",document.getElementById("background-3").className="hidden homepage--background homepage--background--image",document.getElementById("background-4").className="hidden homepage--background homepage--background--image",document.getElementById("background-5").className="homepage--background",document.getElementById("background-6").className="hidden homepage--background")}return document.addEventListener("scroll",function(){window.location.pathname.split("/")[1]==""&&o()}),t}function w(t,o,c,i){let a=!1,n=o;(o==""||o==null)&&(n="collapsible");const s=document.createElement("div");s.setAttribute("id",t),s.setAttribute("class",n+"--container");const r=document.createElement("span");r.setAttribute("id","collapsible-"+t+"-icon"),r.setAttribute("class",n+"--title--text--chevron"),r.innerHTML='<i class="fa-solid fa-chevron-down"></i>';const p=document.createElement("div");p.setAttribute("id",t+"-title"),p.setAttribute("class",n+"--title--container");const h=document.createElement("div");h.setAttribute("class",n+"--title"),h.innerHTML=`<span class=collapsibleClassName + "--title--text">${c} </span>`,h.append(r),p.appendChild(h),s.appendChild(p);const v=document.createElement("div");v.setAttribute("id",t+"-content-container"),v.setAttribute("class",n+"--content--container");const g=document.createElement("div");g.setAttribute("id",t+"-content"),g.setAttribute("class",n+"--content"),g.append(i),v.appendChild(g),s.appendChild(v),p.addEventListener("click",d=>{x()});function x(){a?(v.classList.remove("active"),v.style.maxHeight="0px",r.classList=n+"--title--text--chevron",a=!a):(v.classList.add("active"),v.style.maxHeight="100vh",r.classList=n+"--title--text--chevron--upside-down",a=!a)}return s}let It=new Date("02/14/1999"),St=Date.now()-It.getTime(),xt=new Date(St),Et=xt.getUTCFullYear();const Ce=Math.abs(Et-1970),Ie={fr:{resumeHeaderName:"JONATHAN BINOT",resumeDescription:"D\xE9veloppeur web Frontend - Disponible imm\xE9diatement",resumeIntroText:`Passionn\xE9 d\u2019informatique et du d\xE9veloppement web et curieux des nouvelles
...
></a>`,resumeIntroDrivingLicense:"Driving license (since 03/23/18)"}},Se={fr:{formationTitle:"Formation",openclassroomsFrontend:`
    ...
    </section>`}},_e="/assets/hla-1.b40bd089.jpg",Tt="/assets/PPCV.e4291ca6.png";let E,l;const jt=localStorage.getItem("language");jt==="fr"?(E=Ie.fr,l=Se.fr):(E=Ie.en,l=Se.en);const He=e("section",{class:"resume--header",id:"resume-header"},"",""),ie=e("div",{class:"resume--title",id:"resume-title"},"",He);e("h1",{class:"resume--h1",id:"resume-h1"},E.resumeHeaderName,ie);const Re=e("div",{class:"resume--intro--container"},"",ie);e("img",{class:"profile-picture",id:"profile-picture",src:Tt,height:"92px"},"",Re);const Ne=e("div",{class:"resume--intro--text--container"},"",Re);e("h2",{class:"resume--description"},E.resumeDescription,Ne);e("p",{class:"resume--description"},E.resumeIntroText,Ne);const V=e("aside",{class:"resume--title--info",id:"resume-aside"},"",ie);e("p",{},E.resumeIntroAge,V);e("p",{},E.resumeIntroContact,V);e("p",{},E.resumeIntroLinkedin,V);e("p",{},E.resumeIntroDrivingLicense,V);const T=e("div",{class:"resume--content",id:"resume-content"},"",""),q=e("section",{id:"formation"},"","");e("div",{class:"formation--description"},l.openclassroomsFrontend,q);e("div",{class:"formation--description"},l.openclassroomsWebdev,q);e("div",{class:"formation--description"},l.university,q);e("div",{class:"formation--description"},l.baccalaureate,q);const Bt=w("formation","",l.formationTitle,q);T.append(Bt);const U=e("section",{id:"exp-pro"},"","");e("div",{class:"profesionnal--description"},l.proExpLTDN,U);e("div",{class:"profesionnal--description"},l.proExpPoleEmploi,U);e("div",{class:"profesionnal--description"},l.proExpEpitech,U);const Lt=w("pro-exp","",l.professionalExperienceTitle,U);T.append(Lt);const Q=e("section",{id:"skills",class:"skills"},"",""),Jt=e("div",{class:"skills"},l.computerSkillsContent,""),qt=w("computers","",l.computerSkillsTitle,Jt);Q.append(qt);const Pt=e("div",{class:"skills"},l.softSkillsContent,""),Dt=w("soft-skills","",l.softSkillsTitle,Pt);Q.append(Dt);const Mt=e("div",{class:"skills"},l.languagesSkillsContent,""),_t=w("languages","",l.languagesSkillsTitle,Mt);Q.append(_t);const Ht=w("skills","",l.skillsTitle,Q);T.append(Ht);const Fe=e("section",{id:"projects"},"","");e("div",{class:"profesionnal--description"},l.notableProjectsContent,Fe);const Rt=w("notable-projects","",l.notableProjectsTitle,Fe);T.append(Rt);const z=e("section",{class:"hobby--section"},"",""),Nt=e("div",{class:"hobby"},l.hobbiesMusicContent,""),Ft=w("music","",l.hobbiesMusicTitle,Nt);z.append(Ft);const Ve=e("div",{class:"hobby"},l.hobbiesEditingContent,""),Vt=w("editing","",l.hobbiesEditingTitle,Ve),Ut=e("a",{id:"editing-know-more",class:"resume--example-modal--button",href:"#editing-example"},l.knowMoreText,Ve);z.append(Vt);const Ue=e("div",{class:"hobby"},l.hobbiesGamesContent,""),Qt=w("video-games","",l.hobbiesGamesTitle,Ue),zt=e("a",{id:"gamedev-know-more",class:"resume--example-modal--button",href:"#gamedev-example"},l.knowMoreText,Ue);z.append(Qt);const Ot=w("hobbies","",l.hobbiesSectionTitle,z);T.append(Ot);const Qe=e("section",{},"","");e("div",{class:"profesionnal--description"},l.charitySectionContent,Qe);const Gt=w("charity","",l.charitySectionTitle,Qe);T.append(Gt);const ze=e("div",{class:"resume--example-modal--content"},l.hobbiesEditingModalContent,""),Oe=e("div",{class:"resume--example-modal--image--container"},"",ze);e("img",{class:"resume--example-modal--image",src:"https://scontent-cdt1-1.xx.fbcdn.net/v/t1.6435-9/47196459_2290062601227752_8864858708497137664_n.jpg?_nc_cat=106&ccb=1-7&_nc_sid=09cbfe&_nc_ohc=4CGt6pA3E8MAX-GBf06&tn=32L3dSojrsn1PSud&_nc_ht=scontent-cdt1-1.xx&oh=00_AT8mYppG0LShQDD4kYAAjlvRvgTH-6kn7aztZ0W_YfGYfw&oe=63497675"},"",Oe);e("img",{class:"resume--example-modal--image",src:"https://scontent-cdg2-1.xx.fbcdn.net/v/t1.6435-9/47320482_2290084304558915_1379622247995539456_n.jpg?_nc_cat=107&ccb=1-7&_nc_sid=e3f864&_nc_ohc=zzHSjFy9ch0AX-TKaqC&_nc_ht=scontent-cdg2-1.xx&oh=00_AT_lzzw96Lcqk92Xxlp1UQKiPUqcbB82g8YoJw7kDtFJRg&oe=6346A6DB"},"",Oe);const R=F("know-more-modal",l.hobbiesEditingModalTitle,ze);R.closeButton.addEventListener("click",t=>{t.preventDefault(),j(R.htmlCode)});T.append(R.htmlCode);const Ge=e("div",{class:"resume--example-modal--content"},l.hobbiesGamesModalContent,""),Kt=e("div",{class:"resume--example-modal--image--container"},"",Ge);e("img",{class:"resume--example-modal--image",src:_e},"",Kt);const Ke=e("div",{},"","");e("div",{},"Test",Ke);const Wt=e("button",{},"Test Click",Ke);Wt.addEventListener("click",()=>{console.log("Test")});const N=F("know-more-modal",l.hobbiesGamesModalTitle,Ge);N.closeButton.addEventListener("click",t=>{t.preventDefault(),j(N.htmlCode)});T.append(N.htmlCode);Ut.addEventListener("click",t=>{t.preventDefault(),j(R.htmlCode,!0)});zt.addEventListener("click",t=>{t.preventDefault(),j(N.htmlCode,!0)});function $t(){const t=document.createElement("main");return t.setAttribute("class","resume"),t.appendChild(He),t.appendChild(T),t}const D={fr:{modalTitle:"D\xE9veloppement web",modalIntroText:`Durant mes deux formations avec OpenClassrooms (d\xE9veloppeur web et d\xE9veloppeur d'applications JS et React), 
    ...
    Today, I regularly use editing software, like photo editing software.`}},Na=localStorage.getItem("language");let te;Na==="fr"?(H.fr.videoEditingTitle,te=H.fr):(H.en.videoEditingTitle,te=H.en);const O=e("div",{id:"videoEditing-content",class:"portfolio--modal-content"},"","");e("p",{},te.modalIntroText,O);e("hr",{},"",O);e("h3",{},"WIP",O);e("div",{class:"spacer--vertical--medium"},"",O);const Be={fr:"Voici mon portfolio. Vous avez ici la possibilit\xE9 de cliquer sur le domaine qui vous int\xE9resse et d'explorer les diff\xE9rents travaux et r\xE9alisations que j'ai pu effectuer. Pour commencer, cliquez sur l'une des tuiles ci-dessous.",en:"This is my portfolio. Here you will be able to click on the category you want to see and to explore the different works and realizations I have done. To start, just click on one of the tiles down below."},W=["webdev","gamedev","photoEditing","videoEditing"],Fa=[X,Z,ee],Le=[A,b,I],Va=localStorage.getItem("language");let ae;Va==="fr"?ae=Be.fr:ae=Be.en;const J=e("div",{class:"portfolio",id:""},""),Ua=e("div",{class:"portfolio--header",id:""},"<h1>Portfolio</h1>",J),Qa=e("div",{class:"portfolio--content",id:"portfolio-content"},"",J);e("div",{class:"portfolio--intro",id:"homepage-content"},ae,Ua);function za(t,o,c,i,a){const n=document.createElement("div");n.setAttribute("id",t),n.setAttribute("class",i+" tile--container");const s=document.createElement("h2");s.setAttribute("class","tile--title"),s.innerHTML=o,n.append(s);const r=F(t+"-modal",o,c,"modal-fullscreen",a);return J.append(r.htmlCode),n.addEventListener("click",()=>{j(r.htmlCode,J)}),r.closeButton.addEventListener("click",()=>{j(r.htmlCode)}),n}for(let t=0;t<Le.length;t++)Qa.append(za(W[t],Fa[t],Le[t],"tile--container--"+W[t],W[t]));function Oa(){const t=document.createElement("main");return t.append(J),t}const ue=document.createElement("div");ue.innerHTML=`
<h1>ERREUR 404</h1>`;const $e=e("div",{class:"error-404--go-back"},"",ue),Ga=e("a",{class:"error-404--go-back--button",href:"/"},"",$e),G=e("div",{class:"error-404--go-back--link"},"",Ga);e("img",{class:"language-flag",src:oe,width:64,height:64},"",G);e("br",{},"",G);e("div",{class:"error-404--go-back--text"},"Retour \xE0 la page d'accueil",G);const Ye=e("a",{class:"error-404--go-back--button",href:"/"},"",$e),me=e("div",{class:"error-404--go-back--link"},"",Ye);e("img",{class:"language-flag",src:ne,width:64,height:64},"",me);e("br",{},"",Ye);e("div",{class:"error-404--go-back--text"},"Retour \xE0 la page d'accueil",me);G.addEventListener("click",t=>{localStorage.setItem("language","fr")});me.addEventListener("click",t=>{localStorage.setItem("language","en")});function Ka(){const t=document.createElement("main");return t.append(ue),t}function Wa(){const t=localStorage.getItem("language");(t!=null&&t=="fr"||t!=null&&t=="en")&&(window.location.href="/");const o=document.createElement("main");o.innerHTML+="<h1>Choix de la langue / Select language</h1>";const c=e("div",{class:"error-404--go-back"},"",o),i=e("a",{class:"error-404--go-back--button",href:"/"},"",c),a=e("div",{class:"error-404--go-back--link"},"",i);e("img",{class:"language-flag",src:oe,width:64,height:64},"",a),e("br",{},"",a),e("div",{class:"error-404--go-back--text"},"Retour \xE0 la page d'accueil",a);const n=e("a",{class:"error-404--go-back--button",href:"/"},"",c),s=e("div",{class:"error-404--go-back--link"},"",n);return e("img",{class:"language-flag",src:ne,width:64,height:64},"",s),e("br",{},"",n),e("div",{class:"error-404--go-back--text"},"Retour \xE0 la page d'accueil",s),a.addEventListener("click",r=>{localStorage.setItem("language","fr")}),s.addEventListener("click",r=>{localStorage.setItem("language","en")}),o}console.log(window.location.pathname);const $=window.location.pathname,Je=localStorage.getItem("language"),Y={404:Ka(),"":we(),"/":we(),"/resume":$t(),"/portfolio":Oa()};function $a(){return!Je||Je==null?app.append(Wa()):Y[$]==null?app.append(Y[404]):(app.append(st($)),app.append(Y[$]))}$a();
