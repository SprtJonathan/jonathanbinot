(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))i(a);new MutationObserver(a=>{for(const n of a)if(n.type==="childList")for(const c of n.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&i(c)}).observe(document,{childList:!0,subtree:!0});function l(a){const n={};return a.integrity&&(n.integrity=a.integrity),a.referrerpolicy&&(n.referrerPolicy=a.referrerpolicy),a.crossorigin==="use-credentials"?n.credentials="include":a.crossorigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(a){if(a.ep)return;a.ep=!0;const n=l(a);fetch(a.href,n)}})();const e=(t,o,l,i,a,n)=>{const c=document.createElement(t);for(const[r,p]of Object.entries(o))c.setAttribute(r,p);return a&&c.addEventListener(a,n),c.innerHTML=l,i&&i.appendChild(c),c};function j(t,o){o!=null?(t.classList.add("active"),t.classList.remove("invisible")):(t.classList.remove("active"),t.classList.add("invisible"))}function qe(t,o,l){t||(t=[]);for(let i=0;i<t.length;i++){const a=e("li",{},"",l);e("a",{class:"link",href:t[i]},o[i],a)}}function Q(t,o,l,i,a){const n=t,c=o;let r,p;!i||i==""?r="modal":r=i,a?p="--"+a:p="";const h=e("div",{id:n,class:r+"--container--base"},"",""),v=e("div",{class:r+"--container"},"",h),g=e("div",{class:r+"--content"+p},"",v);a?e("div",{class:r+p},"",g):e("div",{class:r+"--blur"},"",g);const x=e("div",{class:r+"--header"},"",g);(c!=""||c!=null)&&e("h2",{class:r+"--header--text"},c,x);const d=e("button",{type:"button",id:"close-modal",class:r+"--exit"+p},'<i class="fa fa-close"></i>',x);return e("div",{class:r+"--body"},"",g).append(l),{htmlCode:h,closeButton:d}}const be={fr:{resumeTitle:"Mon CV",portfolioTitle:"Portfolio",contactTitle:"Contact",languageTitle:"Langue",contactHeader:"Contactez moi",contactForm:`
    ...
    </form>`}},ne="data:image/png;base64,",ie="/assets/EN.a947de3b.png";function nt(t){const o=t,l=localStorage.getItem("language");let i;l==="fr"?i=be.fr:i=be.en;const a=document.createElement("nav");a.setAttribute("class","navbar"),a.setAttribute("id","navbar-container");const n=document.createElement("div");n.setAttribute("id","display-menu-button"),n.setAttribute("class","navbar--toggle"),n.innerHTML='<i class="navbar--toggle--icon fa-solid fa-bars" id="display-menu-icon"></i>',n.addEventListener("click",b=>{(b.target.id==="display-menu-button"||b.target.id==="display-menu-icon")&&at()});const c=document.createElement("div");c.setAttribute("class","hidden navbar--menu"),c.setAttribute("id","navbar"),a.append(c);let r="navbar--button",p="navbar--button",h="navbar--button";(b=>{b=="/home"||b=="/"?(r="navbar--button active-page",p="navbar--button",h="navbar--button"):b=="/resume"?(r="navbar--button",p="navbar--button active-page",h="navbar--button"):b=="/portfolio"&&(r="navbar--button",p="navbar--button",h="navbar--button active-page")})(o);const g=e("ul",{id:"navbar-buttons-block",class:"navbar--block"},"",c);e("div",{class:"modal--blur"},"",g);const x=e("li",{class:"navbar--li"},"",g);e("a",{id:"home",class:r,href:"/"+l+"/"},'<i class="fa-solid fa-house"></i>',x);const d=e("li",{class:"navbar--li"},"",g);e("a",{id:"resume",class:p,href:"/"+l+"/resume"},i.resumeTitle,d);const y=e("li",{class:"navbar--li"},"",g);e("a",{id:"portfolio",class:h,href:"/"+l+"/portfolio"},i.portfolioTitle,y);const I=e("li",{class:"navbar--li"},"",g),$e=e("a",{id:"contact-button",class:"navbar--button",href:"#contact"},i.contactTitle,I),Ae=e("li",{class:"navbar--li"},"",g),Ye=e("a",{id:"language-menu-button",class:"navbar--button",href:"#language-selection"},i.languageTitle,Ae),ge=e("div",{id:"language-menu",class:"hidden"},"",Ae),Xe=e("a",{class:"navbar--button"},`<img id="select-fr" class="language-flag" src="${ne}" width=48 height=48>`,ge),Ze=e("a",{class:"navbar--button"},`<img id="select-en" class="language-flag" src="${ie}" width=48 height=48>`,ge);$e.addEventListener("click",b=>{b.preventDefault(),j(M.htmlCode,c)}),Ye.addEventListener("click",b=>{b.preventDefault(),tt()}),Xe.addEventListener("click",()=>{he("fr")}),Ze.addEventListener("click",()=>{he("en")});const et=e("div",{},i.contactForm,""),M=Q("contact-modal",i.contactHeader,et);a.append(n),a.append(M.htmlCode);function tt(){document.getElementById("language-menu").className==="hidden"?document.getElementById("language-menu").className="navbar--li--dropdown":document.getElementById("language-menu").className="hidden"}function he(b){console.log("Changement en "+b),localStorage.setItem("language",b),document.documentElement.lang,window.location.href="/"+b+"/"+window.location.pathname.split("/")[2]}M.closeButton.addEventListener("click",()=>{j(M.htmlCode)});let W=!1;function at(){W=!W,ot()}function ot(){W?(document.getElementById("navbar").className="navbar--menu",document.getElementById("display-menu-icon").className="navbar--toggle--icon--after fa-solid fa-bars"):(document.getElementById("navbar").className="navbar--slided navbar",document.getElementById("display-menu-icon").className="navbar--toggle--icon fa-solid fa-bars")}return a}const it="/assets/javascript.8dac5379.svg",fe="/assets/oc-logo.26deeb94.png";let st=new Date("02/14/1999"),rt=Date.now()-st.getTime(),lt=new Date(rt),ct=lt.getUTCFullYear();const ve=Math.abs(ct-1970),ye={fr:{homepageIntroName:"Jonathan Binot",homepageIntroJob:"D\xE9veloppeur web - Frontend - Applications JS",homepageIntroSummary:"Bienvenue sur mon site web personnel.<br /> Diverses pages vous sont ici propos\xE9es, vous y trouverez mon CV en fran\xE7ais et en anglais, ainsi que mon portfolio dans les deux langues \xE9galement.<br /> Mais avant tout, qui suis-je?",homepageIntroIntroduction:`Je m'appelle Jonathan Binot, j'ai <span id="age">${ve}</span> ans et je
...
<img src="${it}" height="18px" /> de niveau Bac +3 obtenus avec
...
page. Bonne visite.`},en:{homepageIntroName:"Jonathan Binot",homepageIntroJob:"Web developer - Frontend - JS Apps",homepageIntroSummary:"Welcome to my personnal website<br /> Different pages are available here, you will find my resume in English and in French, as well as my portfolio in the two languages too.<br /> But before anything else, who am I?",homepageIntroIntroduction:`My name is Jonathan Binot, I'm <span id="age">${ve}</span> year old and I
    ...
    your visit.`}},dt="/assets/webdev.80d57f03.png",pt="/assets/gamedev.52403ad6.png",ut=localStorage.getItem("language");let S;ut==="fr"?S=ye.fr:S=ye.en;const B=e("div",{class:"homepage--content",id:"homepage-content"},"",""),mt=e("section",{id:"summary",class:"intro--section intro--name"},"",B),Je=e("div",{class:"homepage--title--block"},"",mt),At=e("h1",{class:"text-light"},"",Je);e("mark",{class:"text-light blue-underline"},S.homepageIntroName,At);e("h2",{class:"text-light"},S.homepageIntroJob,Je);const gt=e("section",{class:"intro--section intro--summary"},"",B),ht=e("div",{class:"intro--inner-text--block"},"",gt);e("p",{class:"intro--inner-text"},S.homepageIntroSummary,ht);const bt=e("section",{class:"intro--section intro--introduction",style:"background-color: #1e1e1e"},"",B);e("p",{class:"intro--inner-text"},S.homepageIntroIntroduction,bt);const Pe=e("section",{class:"intro--section intro--type webdev"},"",B);e("span",{class:"text-light"},S.homepageWebdevTitle,Pe);e("img",{class:"intro--type--image",src:dt,height:"30%",alt:"Web development illustration picture"},"",Pe);const Me=e("section",{class:"intro--section intro--type gamedev"},"",B);e("img",{class:"intro--type--image",src:pt,height:"30%",alt:"Game development illustration picture"},"",Me);e("span",{class:"text-light"},S.homepageGamedevTitle,Me);const ft=e("section",{class:"intro--section intro--objectives--game"},"",B);e("p",{class:"intro--objectives--text"},S.homepageIntroObectivesGame,ft);const vt=e("section",{class:"intro--section intro--objectives--web"},"",B);e("p",{class:"intro--objectives--text"},S.homepageIntroObjectivesWeb,vt);const ke="/assets/homepage-bg-1.cb525e19.jpg",yt="/assets/homepage-bg-3_frame.035043af.png",kt=`
  ...
  <div id="background-2" class="hidden homepage--background homepage--background--darkgrey" style="background-image: url(${yt})"></div>
  ...
  `;function we(){const t=document.createElement("main");t.setAttribute("class","homepage"),t.setAttribute("id","homepage"),t.appendChild(B),t.innerHTML+=kt;function o(){const l=window.innerHeight;l>=window.pageYOffset?(document.getElementById("background-1").className="homepage--background homepage--background--image",document.getElementById("background-2").className="hidden homepage--background homepage--background--image",document.getElementById("background-3").className="hidden homepage--background homepage--background--image",document.getElementById("background-4").className="hidden homepage--background homepage--background--image",document.getElementById("background-5").className="hidden",document.getElementById("background-6").className="hidden homepage--background",console.log("1 fois "+window.pageYOffset)):l*3>=window.pageYOffset&&window.pageYOffset>=l?(document.getElementById("background-1").className="hidden homepage--background homepage--background--image",document.getElementById("background-2").className="homepage--background homepage--background--image",document.getElementById("background-3").className="hidden homepage--background homepage--background--image",document.getElementById("background-4").className="hidden homepage--background homepage--background--image",document.getElementById("background-5").className="hidden",document.getElementById("background-6").className="hidden homepage--background",console.log("1 fois "+window.pageYOffset)):l*5>=window.pageYOffset&&window.pageYOffset>=l*3&&(document.getElementById("background-1").className="hidden homepage--background homepage--background--image",document.getElementById("background-2").className="hidden homepage--background homepage--background--image",document.getElementById("background-3").className="hidden homepage--background homepage--background--image",document.getElementById("background-4").className="hidden homepage--background homepage--background--image",document.getElementById("background-5").className="homepage--background",document.getElementById("background-6").className="hidden homepage--background",console.log("4 fois "+window.pageYOffset))}return document.addEventListener("scroll",function(){window.location.pathname.split("/")[2]==""&&o()}),t}function k(t,o,l,i){let a=!1,n=o;(o==""||o==null)&&(n="collapsible");const c=document.createElement("div");c.setAttribute("id",t),c.setAttribute("class",n+"--container");const r=document.createElement("span");r.setAttribute("id","collapsible-"+t+"-icon"),r.setAttribute("class",n+"--title--text--chevron"),r.innerHTML='<i class="fa-solid fa-chevron-down"></i>';const p=document.createElement("div");p.setAttribute("id",t+"-title"),p.setAttribute("class",n+"--title--container");const h=document.createElement("div");h.setAttribute("class",n+"--title"),h.innerHTML=`<span class=collapsibleClassName + "--title--text">${l} </span>`,h.append(r),p.appendChild(h),c.appendChild(p);const v=document.createElement("div");v.setAttribute("id",t+"-content-container"),v.setAttribute("class",n+"--content--container");const g=document.createElement("div");g.setAttribute("id",t+"-content"),g.setAttribute("class",n+"--content"),g.append(i),v.appendChild(g),c.appendChild(v),p.addEventListener("click",d=>{x()});function x(){a?(v.classList.remove("active"),v.style.maxHeight="0px",r.classList=n+"--title--text--chevron",a=!a):(v.classList.add("active"),v.style.maxHeight="100vh",r.classList=n+"--title--text--chevron--upside-down",a=!a)}return c}let wt=new Date("02/14/1999"),Ct=Date.now()-wt.getTime(),It=new Date(Ct),St=It.getUTCFullYear();const Ce=Math.abs(St-1970),Ie={fr:{resumeHeaderName:"JONATHAN BINOT",resumeDescription:"D\xE9veloppeur web Frontend - Disponible imm\xE9diatement",resumeIntroText:`Passionn\xE9 d\u2019informatique et du d\xE9veloppement web et curieux des nouvelles
    ...
    ></a>`,resumeIntroAge:`14/02/1999 (${Ce} ans)`,resumeIntroContact:`<a href="mailto:jonathanbinot@gmail.com"
    >Me contacter par Mail <i class="fas fa-external-link-alt"></i
  ...
  <a href="http://github.com/SprtJonathan" target="_blank"
    >https://github.com/SprtJonathan/ <i class="fas fa-external-link-alt"></i
  ></a>`,resumeIntroAge:`02/14/1999 (${Ce} years old)`,resumeIntroContact:`<a href="mailto:jonathanbinot@gmail.com"
  >Send me an email <i class="fas fa-external-link-alt"></i
></a>`,resumeIntroLinkedin:`<a target="_blank" href="https://linkedin.com/in/jonathan-binot-260267154"
...
></a>`,resumeIntroDrivingLicense:"Driving license (since 03/23/18)"}},Se={fr:{formationTitle:"Formation",openclassroomsFrontend:`
    ...
    </section>`}},De="/assets/hla-1.b40bd089.jpg",xt="/assets/PPCV.e4291ca6.png";let E,s;const Et=localStorage.getItem("language");Et==="fr"?(E=Ie.fr,s=Se.fr):(E=Ie.en,s=Se.en);const _e=e("section",{class:"resume--header",id:"resume-header"},"",""),se=e("div",{class:"resume--title",id:"resume-title"},"",_e);e("h1",{class:"resume--h1",id:"resume-h1"},E.resumeHeaderName,se);const He=e("div",{class:"resume--intro--container"},"",se);e("img",{class:"profile-picture",id:"profile-picture",src:xt,height:"92px"},"",He);const Re=e("div",{class:"resume--intro--text--container"},"",He);e("h2",{class:"resume--description"},E.resumeDescription,Re);e("p",{class:"resume--description"},E.resumeIntroText,Re);const O=e("aside",{class:"resume--title--info",id:"resume-aside"},"",se);e("p",{},E.resumeIntroAge,O);e("p",{},E.resumeIntroContact,O);e("p",{},E.resumeIntroLinkedin,O);e("p",{},E.resumeIntroDrivingLicense,O);const T=e("div",{class:"resume--content",id:"resume-content"},"",""),J=e("section",{id:"formation"},"","");e("div",{class:"formation--description"},s.openclassroomsFrontend,J);e("div",{class:"formation--description"},s.openclassroomsWebdev,J);e("div",{class:"formation--description"},s.university,J);e("div",{class:"formation--description"},s.baccalaureate,J);const Tt=k("formation","",s.formationTitle,J);T.append(Tt);const z=e("section",{id:"exp-pro"},"","");e("div",{class:"profesionnal--description"},s.proExpLTDN,z);e("div",{class:"profesionnal--description"},s.proExpPoleEmploi,z);e("div",{class:"profesionnal--description"},s.proExpEpitech,z);const jt=k("pro-exp","",s.professionalExperienceTitle,z);T.append(jt);const G=e("section",{id:"skills",class:"skills"},"",""),Bt=e("div",{class:"skills"},s.computerSkillsContent,""),Lt=k("computers","",s.computerSkillsTitle,Bt);G.append(Lt);const qt=e("div",{class:"skills"},s.softSkillsContent,""),Jt=k("soft-skills","",s.softSkillsTitle,qt);G.append(Jt);const Pt=e("div",{class:"skills"},s.languagesSkillsContent,""),Mt=k("languages","",s.languagesSkillsTitle,Pt);G.append(Mt);const Dt=k("skills","",s.skillsTitle,G);T.append(Dt);const Ne=e("section",{id:"projects"},"","");e("div",{class:"profesionnal--description"},s.notableProjectsContent,Ne);const _t=k("notable-projects","",s.notableProjectsTitle,Ne);T.append(_t);const K=e("section",{class:"hobby--section"},"",""),Ht=e("div",{class:"hobby"},s.hobbiesMusicContent,""),Rt=k("music","",s.hobbiesMusicTitle,Ht);K.append(Rt);const Ve=e("div",{class:"hobby"},s.hobbiesEditingContent,""),Nt=k("editing","",s.hobbiesEditingTitle,Ve),Vt=e("a",{id:"editing-know-more",class:"resume--example-modal--button",href:"#editing-example"},s.knowMoreText,Ve);K.append(Nt);const Fe=e("div",{class:"hobby"},s.hobbiesGamesContent,""),Ft=k("video-games","",s.hobbiesGamesTitle,Fe),Ut=e("a",{id:"gamedev-know-more",class:"resume--example-modal--button",href:"#gamedev-example"},s.knowMoreText,Fe);K.append(Ft);const Qt=k("hobbies","",s.hobbiesSectionTitle,K);T.append(Qt);const Ue=e("section",{},"","");e("div",{class:"profesionnal--description"},s.charitySectionContent,Ue);const Ot=k("charity","",s.charitySectionTitle,Ue);T.append(Ot);const Qe=e("div",{class:"resume--example-modal--content"},s.hobbiesEditingModalContent,""),Oe=e("div",{class:"resume--example-modal--image--container"},"",Qe);e("img",{class:"resume--example-modal--image",src:"https://scontent-cdt1-1.xx.fbcdn.net/v/t1.6435-9/47196459_2290062601227752_8864858708497137664_n.jpg?_nc_cat=106&ccb=1-7&_nc_sid=09cbfe&_nc_ohc=4CGt6pA3E8MAX-GBf06&tn=32L3dSojrsn1PSud&_nc_ht=scontent-cdt1-1.xx&oh=00_AT8mYppG0LShQDD4kYAAjlvRvgTH-6kn7aztZ0W_YfGYfw&oe=63497675"},"",Oe);e("img",{class:"resume--example-modal--image",src:"https://scontent-cdg2-1.xx.fbcdn.net/v/t1.6435-9/47320482_2290084304558915_1379622247995539456_n.jpg?_nc_cat=107&ccb=1-7&_nc_sid=e3f864&_nc_ohc=zzHSjFy9ch0AX-TKaqC&_nc_ht=scontent-cdg2-1.xx&oh=00_AT_lzzw96Lcqk92Xxlp1UQKiPUqcbB82g8YoJw7kDtFJRg&oe=6346A6DB"},"",Oe);const F=Q("know-more-modal",s.hobbiesEditingModalTitle,Qe);F.closeButton.addEventListener("click",t=>{t.preventDefault(),j(F.htmlCode)});T.append(F.htmlCode);const ze=e("div",{class:"resume--example-modal--content"},s.hobbiesGamesModalContent,""),zt=e("div",{class:"resume--example-modal--image--container"},"",ze);e("img",{class:"resume--example-modal--image",src:De},"",zt);const Ge=e("div",{},"","");e("div",{},"Test",Ge);const Gt=e("button",{},"Test Click",Ge);Gt.addEventListener("click",()=>{console.log("Test")});const U=Q("know-more-modal",s.hobbiesGamesModalTitle,ze);U.closeButton.addEventListener("click",t=>{t.preventDefault(),j(U.htmlCode)});T.append(U.htmlCode);Vt.addEventListener("click",t=>{t.preventDefault(),j(F.htmlCode,!0)});Ut.addEventListener("click",t=>{t.preventDefault(),j(U.htmlCode,!0)});function Kt(){const t=document.createElement("main");return t.setAttribute("class","resume"),t.appendChild(_e),t.appendChild(T),t}const D={fr:{modalTitle:"D\xE9veloppement web",modalIntroText:`Durant mes deux formations avec OpenClassrooms (d\xE9veloppeur web et d\xE9veloppeur d'applications JS et React), 
    ...
    <blockquote>Do not repeat yourself*</blockquote>`,jsBaseTitle:'<a class="link" href="https://github.com/SprtJonathan/js-project-base">JS Project Base</a>',administrativeManagerDescription:"Finally, I am currently working in my free time on another project, started thanks to my starter pack by the way",administrativeManagerTitle:'<a class="link" href="https://github.com/SprtJonathan/AdministrativeManager">Administrative Manager</a>',administrativeManagerToggleButton:"Launch demo",administrativeManagerExitButton:"Close demo",developperMotto:"*Don't repeat yourself: one of the main philosophies of the developer."}},Wt=localStorage.getItem("language");let Y,m;Wt==="fr"?(Y=D.fr.modalTitle,m=D.fr):(Y=D.en.modalTitle,m=D.en);const A=e("div",{id:"webdev-content",class:"portfolio--modal-content"},"","");e("p",{},m.modalIntroText,A);e("h3",{},m.firstFormationTitle,A);qe(m.webdevLinks,m.webdevTitles,A);e("h3",{},m.secondFormationTitle,A);qe(m.frontendLinks,m.frontendTitles,A);e("hr",{},"",A);e("p",{},m.personalProjectFailed,A);e("p",{},m.personalProjectRebooted,A);e("h3",{},m.jsBaseTitle,A);const xe=e("button",{class:"iframe--button"},m.administrativeManagerToggleButton,A),re=e("div",{class:"iframe--wrapper"},"",A),$t=e("iframe",{class:"iframe",src:"",frameborder:"0"},"",re);re.style.maxHeight="0px";function Ke(t,o,l,i,a){return l?(o.src="",t.style.paddingBottom="0%",i.textContent=m.administrativeManagerToggleButton):(o.src=a,t.style.paddingBottom="56.25%",i.textContent=m.administrativeManagerExitButton),l=!l,l}let Ee=!1;xe.addEventListener("click",t=>{t.preventDefault(),Ee=Ke(re,$t,Ee,xe,"https://sprtjonathan.github.io/js-project-base/")});e("hr",{},"",A);e("p",{},m.administrativeManagerDescription,A);e("h3",{},m.administrativeManagerTitle,A);const Te=e("button",{class:"iframe--button",id:"iframe-button-1"},m.administrativeManagerToggleButton,A),le=e("div",{class:"iframe--wrapper"},"",A),Yt=e("iframe",{class:"iframe",src:"",frameborder:"0"},"",le);le.style.maxHeight="0px";let je=!1;Te.addEventListener("click",t=>{t.preventDefault(),je=Ke(le,Yt,je,Te,"https://sprtjonathan.github.io/AdministrativeManager/")});e("p",{},m.developperMotto,A);e("div",{class:"spacer--vertical--medium"},"",A);function L(t,o,l){let i=0;console.log(o);let a;l?a=l:a="carousel";const n=e("section",{class:a+"--section"},"",""),c=e("div",{class:a},"",n),r=[];for(let d=0;d<o.length;d++){const y=e("figure",{class:a+"--slide"},"",c);if((o[d].title||o[d].title!="")&&e("div",{class:a+"--media--title"},o[d].title,y),o[d].type=="video"){const I=e("video",{class:a+"--media--video",title:o[d].title,controls:!0,height:"100%"},"",y);e("source",{class:a+"--media--video",src:o[d].link},"",I)}else{const I=e("a",{class:a+"--media--image--link",href:o[d].link,target:"_blank"},"",y);e("img",{class:a+"--media--img",src:o[d].link,alt:o[d].title},"",I)}if(o[d].description||o[d].description!=""){const I=e("figcaption",{class:a+"--media--description"},"",y);e("p",{class:a+"--media--description--text"},o[d].description,I)}r.push(y)}r.forEach((d,y)=>{d.style.transform=`translateX(${y*100}%)`});const p=e("div",{class:a+"--controls--block"},"",c);o.length<=1?p.className="hidden":p.className=a+"--controls--block";const h=e("div",{class:a+"--controls--button--block"},"",p),v=e("button",{id:"previous-button-"+t,class:a+"--controls--button",type:"button"},'<i class="fa-solid fa-chevron-left"></i>',h),g=e("button",{id:"next-button-"+t,class:a+"--controls--button",type:"button"},'<i class="fa-solid fa-chevron-right"></i>',h);v.addEventListener("click",d=>{x(-1)}),g.addEventListener("click",d=>{d.preventDefault(),x(1)});function x(d){i=i+d,i<0&&(i=o.length-1),i>o.length-1&&(i=0),r.forEach((y,I)=>{y.style.transform=`translateX(${100*(I-i)}%)`})}return n}const _={fr:{gamedevTitle:"D\xE9veloppement de Jeux Vid\xE9o",modalIntroText:`Depuis un certain nombre d'ann\xE9es, pendant mon temps libre, je m'int\xE9resse au d\xE9veloppement de jeux vid\xE9o. Je cherche \xE0 comprendre comment les diff\xE9rents jeux auquels je joue habituellement sont cr\xE9\xE9s, j'apprends \xE9galement (toujours en autodidacte) 
    ...
    Below is a new gallery containing some examples of my work on Blender. I would like to point out that the models from other people that I have used are not intended to be redistributed.`,thirdCategoryExamplesTitles:["My head in Half-Life\xB2","FPS project also made with Udemy","Vending machine","Locomotive and Passenger Cart"],thirdCategoryExamplesDescription:["Yes, this is my head added to a Half-Life\xB2 character model. I wanted to show the game to a friend by playing it in cooperation and I thought that the immersion would be even greater if our heads were ingame. (Scan of the heads made with AvatarSDK)","A FSO Polonez Caro: A well known car in Poland. I wanted to be able to use this car in an Unreal Engine project, so I adapted a model I found online so I could use it in the editor. I then made the textures using real images,","Probably one of my most complex models made from scratch: This vending machine was to be used as a prop when I was having fun recreating the first level of Half-Life\xB2 on Unreal Engine 4","I also created simple, non-optimized models of a train and a passenger wagon (the gray models in this image)","This gun is from SktechFab (3D model library), I adapted this model to Half-Life: Alyx so that it replaces the original gun in the game","A FSO Polonez Caro: A well known car in Poland. I wanted to be able to use this car in an Unreal Engine project, so I adapted a model I found online so I could use it in the editor. I then made the textures using real images,"]}},Xt="/assets/hla-2.7f0cf503.jpg",Zt="/assets/hla-3.f1c2997f.jpg",ea="/assets/hla-4.0fa22526.jpg",ta="/assets/hla-5.adf44b46.jpg",aa="/assets/hla-6.b30f5a84.jpg",oa="/assets/udemy-project.d84c5ead.mp4",na="/assets/poldek.6baace25.mp4",ia="/assets/jonathan_player-model.2008a188.gif",sa="/assets/poldek.c8cd363c.png",ra="/assets/vending_machine.5683f18c.png",la="/assets/trainstation_wagons.69bf4159.png",ca=localStorage.getItem("language");let X,u;ca==="fr"?(X=_.fr.gamedevTitle,u=_.fr):(X=_.en.gamedevTitle,u=_.en);const f=e("div",{id:"gamedev-content",class:"portfolio--modal-content"},"","");e("p",{},u.modalIntroText,f);e("hr",{},"",f);e("h3",{},u.firstCategoryName,f);e("p",{},u.firstCategoryDescription,f);const da=[{type:"video",title:"Half-Life Alyx (VR) - Intro",link:"https://thumbs.gfycat.com/GrossPaltryIberianlynx-mobile.mp4",description:""},{type:"image",title:"Half-Life Alyx (VR) - Intro",link:De,description:"dddd"},{type:"image",title:"Half-Life Alyx (VR) - Intro",link:Xt,description:""},{type:"image",title:"Half-Life Alyx (VR) - Intro",link:Zt,description:""},{type:"image",title:"Half-Life Alyx (VR) - Intro",link:ea,description:""},{type:"image",title:"Half-Life Alyx (VR) - Intro",link:ta,description:""},{type:"image",title:"Half-Life Alyx (VR) - Intro",link:aa,description:""}],pa=L("source-2",da,"");f.append(pa);e("hr",{},"",f);e("h3",{},u.secondCategoryName,f);e("p",{},u.secondCategoryDescription,f);const ua=[{type:"video",title:u.secondCategoryExamplesTitles[0],link:oa,description:u.secondCategoryExamplesDescriptions[0]},{type:"video",title:u.secondCategoryExamplesTitles[1],link:na,description:u.secondCategoryExamplesDescriptions[1]}],ma=L("unreal",ua,"");f.append(ma);e("hr",{},"",f);e("h3",{},u.thirdCategoryName,f);e("p",{},u.thirdCategoryDescription,f);const Aa=[{type:"image",title:u.thirdCategoryExamplesTitles[0],link:ia,description:u.thirdCategoryExamplesDescription[0]},{type:"image",title:u.thirdCategoryExamplesTitles[1],link:sa,description:u.thirdCategoryExamplesDescription[1]},{type:"image",title:u.thirdCategoryExamplesTitles[2],link:ra,description:u.thirdCategoryExamplesDescription[2]},{type:"image",title:u.thirdCategoryExamplesTitles[3],link:la,description:u.thirdCategoryExamplesDescription[3]}],ga=L("source-2",Aa,"");f.append(ga);e("div",{class:"spacer--vertical--medium"},"",f);const H={fr:{photoEditingTitle:"Montage Photo",modalIntroText:`Depuis que j'ai commenc\xE9 \xE0 me renseigner sur de nombreux aspects de la cr\xE9ation en informatique, j'ai appris \xE0 utiliser des outils de photomontage et notamment Adobe Photoshop. Je me sers aujourd'hui tr\xE8s r\xE9guli\xE8rement de ce logiciel afin de r\xE9aliser divers visuels pour mes projets. 
    ...
    but I was able to help a few people with simple illustrations.`,facebookPpTitle:"Facebook Profile Picture",facebookPpText:"Despite the fact that it does not highlight me, I enjoyed doing this profile picture. I prefer it to a personal photo in the case of Facebook.",streamKitTitle:"StreamKit",streamKitText:"Pretty present on the internet and a spectator on social networks, I had several opportunities to help small streamers to customize their channel, particularly thanks to my use of Photoshop. I created various visuals for them, in the form of tiles (visual elements they put on their Twitch channel for instance in order to inform users), but also overlays for their streams (image over the video stream).",logosTitle:"Friend Profile Pictures",logosText:"Several times I have offered my friends to create profile pictures for their social networks. For the most part, I had fun reusing a style that I had first used on my own logo.",companyLogoTitle:"Company Logo",companyLogoText:"In addition to making logos for friends' profile pictures, I also had the opportunity to make the Arca Soudure company logo."}},ha="/assets/facebook-pp-1.a13d080d.png",ba="/assets/facebook-pp-2.8980fc73.png",fa="/assets/facebook-pp-3.755ebb86.png",va="/assets/facebook-banner-1.280e4106.png",ya="/assets/facebook-banner-2.2146894d.png",ka="/assets/stream-kit-1.452e2fbf.png",wa="/assets/stream-kit-2.cd594033.png",Ca="/assets/ddp-logo.a437e4c1.png",Ia="/assets/seehna-logo.ecd56810.png",Sa="/assets/spart-logo.5710f891.png",xa="/assets/hybridus-logo.9059cad3.png",Ea="/assets/ryzer-logo.3ff6df98.png",Ta="/assets/1stin-logo.bce32156.png",ja="/assets/company-logo-1.b4a8cd38.png",Ba="/assets/company-logo-2.ef1ce2eb.png",La=localStorage.getItem("language");let Z,w;La==="fr"?(Z=H.fr.photoEditingTitle,w=H.fr):(Z=H.en.photoEditingTitle,w=H.en);const C=e("div",{id:"photoEditing-content",class:"portfolio--modal-content"},"","");e("p",{},w.modalIntroText,C);e("hr",{},"",C);const ce=e("div",{},"",C);e("h3",{},w.facebookPpTitle,ce);const qa=[{type:"image",title:"",link:ha,description:""},{type:"image",title:"",link:ba,description:""},{type:"image",title:"",link:fa,description:""},{type:"image",title:"",link:va,description:""},{type:"image",title:"",link:ya,description:""}],Ja=L("streamKit",qa,"");ce.append(Ja);e("p",{},w.facebookPpText,ce);e("hr",{},"",C);const de=e("div",{},"",C);e("h3",{},w.streamKitTitle,de);const Pa=[{type:"image",title:"",link:ka,description:""},{type:"image",title:"",link:wa,description:""}],Ma=L("streamKit",Pa,"");de.append(Ma);e("p",{},w.streamKitText,de);e("hr",{},"",C);const pe=e("div",{},"",C);e("h3",{},w.logosTitle,pe);const Da=[{type:"image",title:"",link:Ca,description:""},{type:"image",title:"",link:Ia,description:""},{type:"image",title:"My logo",link:Sa,description:""},{type:"image",title:"Discord bot logo",link:xa,description:""},{type:"image",title:"",link:Ea,description:""},{type:"image",title:"",link:Ta,description:""}],_a=L("streamKit",Da,"");pe.append(_a);e("p",{},w.logosText,pe);e("hr",{},"",C);const ue=e("div",{},"",C);e("h3",{},w.companyLogoTitle,ue);const Ha=[{type:"image",title:"",link:ja,description:""},{type:"image",title:"",link:Ba,description:""}],Ra=L("streamKit",Ha,"");ue.append(Ra);e("p",{},w.companyLogoText,ue);e("div",{class:"spacer--vertical--medium"},"",C);const R={fr:{videoEditingTitle:"Montage vid\xE9o",modalIntroText:`Comme vous avez surement pu le constater, je touche un peu \xE0 tout. Tr\xE8s curieux, je me passionne pour tout ce qui touche \xE0 la cr\xE9ation de divertissements et au domaine audiovisuel plus globalement. 
    ...
    Today, I regularly use editing software, like photo editing software.`}},Na=localStorage.getItem("language");let ee,te;Na==="fr"?(ee=R.fr.videoEditingTitle,te=R.fr):(ee=R.en.videoEditingTitle,te=R.en);const P=e("div",{id:"videoEditing-content",class:"portfolio--modal-content"},"","");e("p",{},te.modalIntroText,P);e("hr",{},"",P);e("h3",{},"WIP",P);e("div",{class:"spacer--vertical--medium"},"",P);const Be={fr:"Voici mon portfolio. Vous avez ici la possibilit\xE9 de cliquer sur le domaine qui vous int\xE9resse et d'explorer les diff\xE9rents travaux et r\xE9alisations que j'ai pu effectuer. Pour commencer, cliquez sur l'une des tuiles ci-dessous.",en:"This is my portfolio. Here you will be able to click on the category you want to see and to explore the different works and realizations I have done. To start, just click on one of the tiles down below."},$=["webdev","gamedev","photoEditing","videoEditing"],Va=[Y,X,Z,ee],Le=[A,f,C,P],Fa=localStorage.getItem("language");let ae;Fa==="fr"?ae=Be.fr:ae=Be.en;const q=e("div",{class:"portfolio",id:""},""),Ua=e("div",{class:"portfolio--header",id:""},"<h1>Portfolio</h1>",q),Qa=e("div",{class:"portfolio--content",id:"portfolio-content"},"",q);e("div",{class:"portfolio--intro",id:"homepage-content"},ae,Ua);function Oa(t,o,l,i,a){const n=document.createElement("div");n.setAttribute("id",t),n.setAttribute("class",i+" tile--container");const c=document.createElement("h2");c.setAttribute("class","tile--title"),c.innerHTML=o,n.append(c);const r=Q(t+"-modal",o,l,"modal-fullscreen",a);return q.append(r.htmlCode),n.addEventListener("click",()=>{j(r.htmlCode,q)}),r.closeButton.addEventListener("click",()=>{j(r.htmlCode)}),n}for(let t=0;t<Le.length;t++)Qa.append(Oa($[t],Va[t],Le[t],"tile--container--"+$[t],$[t]));function za(){const t=document.createElement("main");return t.append(q),t}const We=document.createElement("div");We.innerHTML=`
<h1>ERREUR 404</h1>
<div class="error-404--go-back">
  <a class="error-404--go-back--button" href="/fr/">
    <div class="error-404--go-back--link"><img class="language-flag" src="${ne}" width=64 height=64> 
      </br> 
      <div class="error-404--go-back--text">Retour \xE0 la page d'accueil</div>
    </div>
  </a>
  <a class="error-404--go-back--button" href="/en/">
    <div class="error-404--go-back--link"><img class="language-flag" src="${ie}" width=64 height=64>
      </br> 
      <div class="error-404--go-back--text">Go back to the homepage</div>
    </div>
  </a>
</div>
`;function Ga(){const t=document.createElement("main");return t.append(We),t}function Ka(){const t=localStorage.getItem("language");(t!=null&&t=="fr"||t!=null&&t=="en")&&(window.location.href="/"+t+"/");const o=document.createElement("main");return o.innerHTML+="<h1>Choix de la langue / Select language</h1>",o.innerHTML+=`
  <div class="error-404--go-back">
    <a class="error-404--go-back--button" href="/fr/">
      <div class="error-404--go-back--link"><img class="language-flag" src="${ne}" width=64 height=64> 
        </br> 
  ...
  `,o}const Wa=["","fr","en"],oe=window.location.pathname,N=oe.split("/")[1],$a=t=>{t=t||window.event,t.preventDefault(),window.history.pushState({},"",t.target.href),me()},V={404:Ga(),"":we(),"/":we(),"/resume":Kt(),"/portfolio":za()},me=async()=>{document.documentElement.lang=N;const t=oe.split(N)[1],o=document.querySelector("#app");if(Wa.includes(oe.split("/")[1]))localStorage.getItem("language")||localStorage.setItem("language",N);else return o.append(V[404]);if(t==null||N=="")return o.append(Ka());const l=V[t]||V[404];return console.log(t),l!=V[404]&&o.append(nt(t)),o.append(l)};window.onpopstate=me;window.route=$a;me();
