...
createElementFromTemplate("h3", {}, "Développeur Web : ", webdevContent);

webdevContent.innerHTML = `
      <p>Durant mes deux formations avec OpenClassrooms (développeur web et développeur d'applications JS et React), j'ai pu réaliser de nombreux projets, en voici la liste</p>
      ...
      <p>*Ne vous répétez pas : une des philosophies principales du développeur.</p>
      `;
